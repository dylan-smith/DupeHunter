...
/// </summary>
internal readonly record struct PendingHash(long Id, string FullPath, long SizeBytes);

/// <summary>The outcome of hashing one file in pass two, keyed back to its table row by <see cref="Id"/>.</summary>
internal readonly record struct HashResult(long Id, string? ContentHash, string? Error);
...
/// </summary>
internal readonly record struct HashedFile(
...
/// </summary>
internal readonly record struct FolderRecord(
